...
import { useApproveReviewScroreProjectMutation } from '@/data/project';
...
const ApproveProject = ({ scorereview, reviewid }) => {
    ...
    const { mutate: ApproveReviewScoreAction } = useApproveReviewScroreProjectMutation()
    ...
    const onSubmit = (values) => {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ApproveReviewScoreAction(postData)
                setHideApprove(true)
            }
        });
    }
                                    ...
                                    <div className="tab-content">
                                        <div className="pt-3">
                                            <div className="settings-form">
                                                <Formik
                                                    initialValues={{
                                                        overviewscore: scorereview?.overreview,
                                                        basicscore: scorereview?.basicreview,
                                                        advancescore: scorereview?.advancereview,
                                                        expertscore: scorereview?.expertreview,
                                                    }}
