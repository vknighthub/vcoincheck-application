    ...
    return (
        ...
        <div className="pt-3">
            <div className="settings-form tab-content">
                ...
                {!hiddenEdit &&
                    <div className="pt-5">
                        <Link href="#" className="btn btn-primary mr-2" onClick={() => changeUserInformations()}>{t('edit')}</Link>
                        <Link href="#" className="btn btn-primary" onClick={() => changePasswordInformations()} >{t('changepwd')}</Link>
                    </div>
                }
