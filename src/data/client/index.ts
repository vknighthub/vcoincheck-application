...
class Client {
    ...
    faq = {
        ...
        add: (input: EditFaqsInput) => HttpClient.post<EditFaqsResponse>(API_ENDPOINTS.ADDFAQ, input),
        edit: (input: EditFaqsInput) => HttpClient.post<EditFaqsResponse>(API_ENDPOINTS.EDITFAQ, input),
        delete: (input: DeleteFaqsInput) => HttpClient.post<DeleteFaqResponse>(API_ENDPOINTS.DELETE_FAQ, input)
    }
    library = {
